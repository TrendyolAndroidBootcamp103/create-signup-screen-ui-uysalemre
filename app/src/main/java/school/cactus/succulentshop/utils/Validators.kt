...
fun validateUsername(context: Context, field: String): String? {
...
fun validateEmail(context: Context, field: String): String? {
...
fun validateUsernameOrEmail(context: Context, field: String): String? {
...
fun validatePassword(context: Context, field: String): String? {
